...
\begin{section}{Research Interests}
  Edge Computing, Network Optimization for Distributed Deep Learning, and Applications of Markov Decision Process (MDP).
...
\begin{section}{Awards \& Achievements}
    Awarded \cusemph{$1$st place Scholarship} from 2014 to 2018
